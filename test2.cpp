...
constexpr auto DRMScreenCapture_Init = &DRMScreenCaptureApi::Init;
constexpr auto DRMScreenCapture_GetScreenInfo = &DRMScreenCaptureApi::GetScreenInfo;
constexpr auto DRMScreenCapture_ScreenCapture = &DRMScreenCaptureApi::ScreenCapture;
constexpr auto DRMScreenCapture_Destroy = &DRMScreenCaptureApi::Destroy;
...
int main() {
	DRMScreenCapture_Init();
	int a = DRMScreenCapture_Init;	// to see what type DRMScreenCapture_Init is
	int b = DRMScreenCapture_GetScreenInfo;
